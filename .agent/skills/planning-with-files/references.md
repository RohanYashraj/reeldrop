...
|------|---------|--------------|--------------|
| `task_plan.md` | Feature roadmap, genre support, platform steps | Task start | After completing phases |
| `findings.md` | API research (Runway, YouTube), video specs | After ANY discovery | After viewing docs/images |
| `progress.md` | Implementation log, FFmpeg test results | At breakpoints | Throughout session |
| Code files | AI logic, API routes, UI components | Before execution | After errors/testing |
